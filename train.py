...
class Trainer:
    def __init__(
        ...
        self.device = device
        self.model = CrossEncoder(self.bert_name_or_path, "cls")
...
def main():
    ...
    dev_dataloader = DataLoader(dataset=dev_dataset, batch_size=batch_size, shuffle=False, num_workers=1)
